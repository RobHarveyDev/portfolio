<header class="w-full flex flex-row justify-between items-center h-20 p-4 border-b-2 border-black">
    ...
    <div>
        <a href="https://github.com/DrCake" target="_black" rel="noreferrer" class="block text-black w-7 h-7 mr-3 fill-current">
